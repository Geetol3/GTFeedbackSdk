...
import com.geetol3.feedback.adapters.GTSuggestListAdapter;
...
public class GTSuggestListActivity extends BaseGTActivity {
    ...
    private void getData(boolean isRefresh) {
        ...
        HttpHelper.getFeedbackList(mCurrentPage, mLimit,
                new BaseCallback<ListResultBean<FeedbackBean>>() {
            @Override
            ...
            @Override
            public void onSuccess(Response response, ListResultBean<FeedbackBean> o) {
                mProgressBar.setVisibility(View.GONE);
                mRefreshLayout.finishRefresh();
                mRefreshLayout.finishLoadMore();
                if (isRefresh) {
