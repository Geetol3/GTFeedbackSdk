...
import com.geetol3.feedback.adapters.GTImageShowAdapter;
import com.geetol3.feedback.adapters.GTReplyAdapter;
import com.geetol3.feedback.beans.FeedbackDetailBean;
...
public class GTSuggestDetailActivity extends BaseGTActivity {
    ...
    private void getData() {
        HttpHelper.getFeedbackDetail(mServiceId, new BaseCallback<DataResultBean<FeedbackDetailBean>>() {
            @Override
            ...
            @Override
            public void onSuccess(Response response, DataResultBean<FeedbackDetailBean> o) {
                mProgressBar.setVisibility(View.GONE);
    ...
    private void endService() {
        HttpHelper.endFeedback(mServiceId, new BaseCallback<ResultBean>() {
            @Override
            public void onRequestBefore() {
                mProgressBar.setVisibility(View.VISIBLE);
            }
